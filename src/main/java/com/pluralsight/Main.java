...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Moped slowDrive = new Moped("Pink", 1, 5, 2, true,
        ...
        Car easyDrive = new Car("Red", 4, 15, 12, true,
        ...
        SemiTruck largestDrive = new SemiTruck("Purple", 1, 100, 300, true,
                false, true, false, 20, 30);
        ...
        Hovercraft amphiDrive = new Hovercraft("black", 3, 20, 20, true,
                true, true, false, 60, 50);
...
//my first choice
        System.out.printf("The getaway vehicle working? %b\n its electric? %b\n it's traceable? %b\n it's hotwireable? %b\n the stealth rating is %d\n the fuel efficiency score is %d\n ",
                easyDrive.isWorking(), easyDrive.isElectric(), easyDrive.isTrackable(), easyDrive.isHotwireable(), easyDrive.getStealthRating(), easyDrive.getFuelEfficiency());
        easyDrive.disableTracking();
    }
